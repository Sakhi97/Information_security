...
To integrate browsers with the KeePassXC desktop application, go to **Settings**, choose the **Browser Integration option**, and then select the **Enable browser integration on checkbox**. Activate the integration for the browsers you possess.
