...
if you do not have brew installed then you can go to [brew's website](https://brew.sh/) and copy the command and run in the terminal 

<img src="https://github.com/Sakhi97/Information_security/blob/main/h5/img/homebrew.png" width="800" height="400">

I already installed keepassxc and below is example how it would look if it installed if you run the command 
