...
After I had to download the file debian-11.6.0-arm64-netinst.iso from the website https://cdimage.debian.org/debian-cd/current/arm64/iso-cd/ and install. After I had to emulate the linux format and open the downloaded file file debian-11.6.0-arm64-netinst.iso in the last task I had to pick xcfe desktop to install
