...
Next, I downloaded the most popular dictionary Rockyou with the commands `wget https://github.com/danielmiessler/SecLists/raw/master/Passwords/Leaked-Databases/rockyou.txt.tar.gz` `tar xf rockyou.txt.tar.gz`and `rm rockyou.txt.tar.gz`
